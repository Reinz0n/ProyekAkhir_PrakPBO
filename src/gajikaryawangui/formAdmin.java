...
public void selectData() {
   ...
   public void clearData(){
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(bHapus, javax.swing.GroupLayout.PREFERRED_SIZE, 47, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void bSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bSimpanActionPerformed
       ...
       String SQL = "INSERT INTO karyawan(nama,alamat,umur,tgl_diterima,golongan,gaji,username,password) "
               + "VALUES('"+tNama.getText()+"','"+tAlamat.getText()+"','"+tUmur.getText()+"','"+tTanggal.getText()+"',"
               + "'"+cbGolongan.getSelectedItem()+"','"+tGaji.getText()+"','"+tUsername.getText()+"','"+tPassword.getText()+"')";
       int status;
    ...
    private void bHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bHapusActionPerformed
        ...
        if (baris != -1) {
            ...
            String SQL = "DELETE FROM karyawan WHERE no='"+no+"'";
            int status = koneksiDB.execute(SQL);
            if (status==1) {
